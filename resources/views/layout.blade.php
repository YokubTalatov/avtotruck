  ...
  <div id="wrapper">
	...
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	  ...
	  @if (auth()->user()->roles->name != "admin")
	   <li class="nav-item">
		<a class="nav-link" href="{{ route("trucks") }}">
		  <i class="fas fa-truck fa-truck-area"></i>
		  <span>Truck</span></a>
	  </li>
	  @endif
	  <!-- Nav Item - TruckDriver -->
	  @if (auth()->user()->roles->name != "admin")
	   <li class="nav-item">
		<a class="nav-link" href="{{ route("truckdrivers") }}">
		  <i class="fas fa-truck fa-truck-area"></i>
		  <span>Truck Drivers</span></a>
	  </li>
	  @endif

	  <!-- Nav Item - Driver Type -->
	  @if (auth()->user()->roles->name != "dispatcher")
	  @if (auth()->user()->roles->name != "director")
	   <li class="nav-item">
		<a class="nav-link" href="{{ route("drivertypes") }}">
		  <i class="fas fa-user fa-user-area"></i>
		  <span>Driver Types</span></a>
	  </li>
	  @endif
	  @endif
