    ...
    <div class="col-sm-8 offset-sm-2">
        ...
        <form method="post" action="{{ route('updateuser', $user->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="paswword" value={{ $user->password }} />
            </div>
            <div class="form-group">
                <label for="first_name">Telegram User Id:</label>
                <input type="text" class="form-control" name="telegramuserid" value={{ $user->telegram_user_id }} />
            </div>
